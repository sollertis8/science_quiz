...
const QUESTIONS = [
  {
    text: 'What does the theory of evolution say about modern human origins?',
    answers: [
      {text: 'Humans come from Apes'},
      {text: 'Humans share a common ancestor with Apes'},
      {text: 'Humans were created by a race of aliens'},
      {text: 'Humans were created by gods'}
    ],
    correctAnswer: 1
  },
  ...
  {number: '6',
    ...
    a: 'A. 10 meters per second squared',
    b: 'B. 9.5 feet per second',
